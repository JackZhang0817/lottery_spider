...
class LotteryRecordSpider(scrapy.Spider):
    name = 'lottery_record2'
    download_delay = 1
    allowed_domains = ['www.2m010.cc']
    start_urls = ['https://www.2m010.cc/history/2018.html']
    # for i in range(1993, 2018):
    #     start_urls.append('https://www.2m010.cc/history/%d.html' %i)
    ...
    def parse(self, response):
        ...
        for i in range(len(se_tr) - 1):
            ...
            se_1 = se.xpath("//div[@id='main']//tr[%d + 2]/td[4]/div[1]/div[1]/div[1]/@class" % i).extract()
            se_2 = se.xpath("//div[@id='main']//tr[%d + 2]/td[4]/div[1]/div[2]/div[1]/@class" % i).extract()
            se_3 = se.xpath("//div[@id='main']//tr[%d + 2]/td[4]/div[1]/div[3]/div[1]/@class" % i).extract()
            se_4 = se.xpath("//div[@id='main']//tr[%d + 2]/td[4]/div[1]/div[4]/div[1]/@class" % i).extract()
            se_5 = se.xpath("//div[@id='main']//tr[%d + 2]/td[4]/div[1]/div[5]/div[1]/@class" % i).extract()
            se_6 = se.xpath("//div[@id='main']//tr[%d + 2]/td[4]/div[1]/div[6]/div[1]/@class" % i).extract()
            se_1 = re.findall(re_color, se_1[0])
            se_2 = re.findall(re_color, se_2[0])
            se_3 = re.findall(re_color, se_3[0])
            se_4 = re.findall(re_color, se_4[0])
            se_5 = re.findall(re_color, se_5[0])
            se_6 = re.findall(re_color, se_6[0])
            ...
            special_color = se.xpath("//div[@id='main']//tr[%d + 2]/td[5]/div/div[1]/@class" % i).extract()
            special_color = re.findall(re_color, special_color[0])
            ...
            heibai = se.xpath("//div[@id='main']//tr[%d + 2]/td[20]/text()" % i).extract()
            sexiao = se.xpath("//div[@id='main']//tr[%d + 2]/td[21]/text()" % i).extract()
            bihua = se.xpath("//div[@id='main']//tr[%d + 2]/td[22]/text()" % i).extract()
            sex = se.xpath("//div[@id='main']//tr[%d + 2]/td[23]/text()" % i).extract()
            zonghe = se.xpath("//div[@id='main']//tr[%d + 2]/td[24]/text()" % i).extract()

            item = LotteryRecordItem()
            item['create_time'] = create_time[0]
            item['time'] = create_time[0]
            ...
            item['special_color'] = special_color[0]
...
class GetNewCtSpider(CrawlSpider):
    ...
    start_urls = ['https://www.2m010.cc/history/2018.html']
    rules = (
        Rule(LinkExtractor(allow=(r'/history/2018.html')),
             callback="parse_item",
             follow=True),
    )
    for url in rules:
